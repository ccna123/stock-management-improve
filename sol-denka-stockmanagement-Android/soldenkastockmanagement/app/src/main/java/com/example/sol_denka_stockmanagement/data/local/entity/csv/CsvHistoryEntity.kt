package com.example.sol_denka_stockmanagement.data.local.entity.csv
...
@Entity(
    tableName = "CsvHistory", foreignKeys = [
        ForeignKey(
            entity = com.example.sol_denka_stockmanagement.data.local.entity.csv.CsvTaskTypeEntity::class,
