package com.example.sol_denka_stockmanagement.data.local.entity.ledger
...
@Entity(
    tableName = "LedgerItem", foreignKeys = [
        ...
        ForeignKey(
            entity = _root_ide_package_.com.example.sol_denka_stockmanagement.data.local.entity.winder.WinderEntity::class,
