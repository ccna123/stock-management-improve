package com.example.sol_denka_stockmanagement.data.local.entity.tag
...
@Entity(
    tableName = "TagMaster", foreignKeys = [
        ForeignKey(
            entity = _root_ide_package_.com.example.sol_denka_stockmanagement.data.local.entity.tag.TagStatusMasterEntity::class,
