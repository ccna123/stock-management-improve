package com.example.sol_denka_stockmanagement.data.local.entity.item
...
@Entity(
    tableName = "ItemTypeMaster", foreignKeys = [
        ForeignKey(
            entity = _root_ide_package_.com.example.sol_denka_stockmanagement.data.local.entity.item.ItemUnitMasterEntity::class,
        ...
        ForeignKey(
            entity = _root_ide_package_.com.example.sol_denka_stockmanagement.data.local.entity.item.ItemCategoryEntity::class,
