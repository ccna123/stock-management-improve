...
@Composable
fun StorageAreaChangeScanScreen(
    ...
    LaunchedEffect(Unit) {
        scanViewModel.setEnableScan(enabled = true, screen = Screen.StorageAreaChangeScan)
        appViewModel.onGeneralIntent(ShareIntent.ClearTagSelectionList)
    }

    Layout(
        topBarText = Screen.StorageAreaChangeScan.displayName,
        topBarIcon = Icons.AutoMirrored.Filled.ArrowBack,
        currentScreenNameId = Screen.StorageAreaChangeScan.routeId,
        ...
        bottomButton = {
            Row(
                ...
                ButtonContainer(
                    ...
                    onClick = {
                        onNavigate(Screen.StorageAreaChange)
                    }
                )
            }
        },
